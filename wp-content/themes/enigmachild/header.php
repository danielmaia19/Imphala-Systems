		...
		<div class="container" >
			...
			<div class="row ">
				...
				<?php } ?>
					...
					<li class="twitter" data-toggle="tooltip" data-placement="bottom" title="Twiiter"><a target="_blank" href="<?php echo esc_url($wl_theme_options['twitter_link']); ?>"><i class="fa fa-twitter"></i></a></li>
